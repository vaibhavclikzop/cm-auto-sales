    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="">
                ...
                @if ($rolePermissions->where('permission_name', 'status')->where('view', 1)->where('create', 1)->isNotEmpty())
                    ...
                    @foreach ($status as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($rolePermissions->where('permission_name', 'status')->where('view', 1)->where('edit', 1)->isNotEmpty())
