    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="">
              ...
              @if ($rolePermissions->where('permission_name', 'user_role')->where('view', 1)->where('create', 1)->isNotEmpty())
                ...
                <tbody>
                    ...
                    @foreach ($role as $item)
                        <tr>
                            ...
                            <td>
                                              @if ($rolePermissions->where('permission_name', 'user_role')->where('view', 1)->where('edit', 1)->isNotEmpty())
                                ...
                                <button class="btn btn-primary btn-sm edit" type="button" data-id="{{ $item->id }}"
                                    ...
                                    <a class="btn btn-sm btn-info" href="/user-permission/{{$item->id}}"><i class="fa fa-eye" aria-hidden="true"></i></a>
