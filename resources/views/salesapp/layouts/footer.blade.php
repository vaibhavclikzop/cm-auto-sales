 <footer class="adminuiux-mobile-footer style-1">
     <div class="container">
         <ul class="nav nav-pills nav-justified">
             <li class="nav-item"><a class="nav-link" href="/sales-app/dashboard"><span><i class="nav-icon"
                             data-feather="home"></i> <span class="nav-text">Home</span></span></a></li>
             <li class="nav-item"><a class="nav-link" href="/sales-app/ready-to-deliver?status=pending"><span>
                      <i class="fa-solid fa-truck-fast"></i> <span class="nav-text">Ready to
                             Deliver</span></span></a>
             </li>
             <li class="nav-item"><a class="nav-link" href="/sales-app/ready-to-deliver?status=delivered"><span>
          <i class="fa-regular fa-truck"></i> <span class="nav-text">Delivered</span></span></a>
             </li>
             {{-- <li class="nav-item"><a href="/sales-app/add-lead" class="nav-link center-menu-btn"><span
                            class="bg-theme-r-gradient rounded-circle text-white"><i
                                class="nav-icon bi bi-plus-lg text-white"></i></span></a></li>
                <li class="nav-item"><a class="nav-link" href="/sales-app/quotes/generated quote"><span><i
                                class="nav-icon" data-feather="file"></i> <span
                                class="nav-text">Quotes</span></span></a></li>
                <li class="nav-item"><a class="nav-link" href="/sales-app/quotes/generated pi"><span><i class="nav-icon"
                                data-feather="file-text"></i> <span class="nav-text">PI</span></span></a>
                </li> --}}
         </ul>
     </div>
 </footer>
 ...
 {{-- 
<button class="floating-btn btn" data-bs-toggle="modal" data-bs-target="#expenseModal">
