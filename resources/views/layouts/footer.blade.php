            ...
            <div class="modal-body p-4">
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body d-flex flex-column p-4">
                                <div class="alert alert-warning border-warning mb-4">
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                    <strong>Open the CRM link:</strong>For Delivery :  Open the provided CRM URL in Safari or Chrome on your iPhone(https://cminfotech.org/sales-app).
                                    <strong>Open the CRM link:</strong>For Order :  Open the provided CRM URL in Safari or Chrome on your iPhone(https://cminfotech.org/lead-app).
                                </div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start mb-4">
                ...
                <div class="text-center mt-4 pt-4 border-top">
                    <div class="d-inline-block">
                        <a href="{{ asset('cm-order.apk') }}" class="btn btn-primary btn-lg px-5 py-3" download>
                            <i class="fas fa-download me-2"></i>Download APK for Android Platforms Sales
                      ...
                      <div class="d-inline-block mt-3">
                        <a href="{{ asset('delivery.apk') }}" class="btn btn-primary btn-lg px-5 py-3" download>
                            <i class="fas fa-download me-2"></i>Download APK for Android Platforms Dispatch
                            <div class="fw-normal small mt-2">
                                <!--<i class="fab fa-android me-1"></i> Android &
                                <i class="fab fa-apple ms-2 me-1"></i> iOS Compatible-->
                            </div>
...
<div id="loader" style="display:none;">
    <img src="/logo/{{ $setting->img }}" width="120px">
</div>
