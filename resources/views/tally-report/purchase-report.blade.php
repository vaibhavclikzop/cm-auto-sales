...
@section('main-section')
    @push('title')
        <title>Purchase Report Tally</title>
    @endpush
    <style>
        table {
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div>
                <button id="exportToExcelTally"
                    data-name="Tally Purchase Report{{ Request('fromDt') }}{{ Request('toDt') }}"
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                {{ \Carbon\Carbon::parse($item->supplier_invoice_date)->format('d-m-Y') }}
                            </td>

                            <td>{{ $item->party_ledger_name }}</td>
